...
public final class offer1_jsp extends org.apache.jasper.runtime.HttpJspBase
...
else
{
      ...
      out.write("\r\n");
      out.write("<form name=\"offer\" action=\"offer1.jsp\" method=\"post\" > \r\n");
...
int flag=0;
      ...
      out.write("\r\n");
      out.write("<center>\r\n");
      out.write("<table><tr><td><div class=\"tab\"> Description</div></td>\r\n");
      out.write("        <td><div class=\"tab\">Amount</div></td>\r\n");
      out.write("        <td><div class=\"tab\">Select</div></td>\r\n");
      out.write("    </tr>\r\n");
...
while(rs.next()){
	...
	if(rs.getString("operator").compareTo(operator)==0 /* && rs.getString("state").compareTo(state)==0 */)
      ...
      out.print(amount );
      out.write("</div></td>\r\n");
      out.write("                    <td  class=\"tab\"> <a href=\"sesion.jsp?id=");
