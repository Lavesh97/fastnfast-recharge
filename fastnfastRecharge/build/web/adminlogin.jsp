...
<body>
	...
	<div id="about_text"><c><h3><a href="adminoffer.jsp"><li>Update Offer<br/> 
                            <a href="adminsub.jsp"><br/><li>See subscribed people list<br/>	
	<a href="adminreguser.jsp"><br/><li>See registered user list</h3>
                </c>
