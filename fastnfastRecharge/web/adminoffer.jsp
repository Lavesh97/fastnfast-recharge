...
out.print("<div id=\"about_text\"> <table width=\"80%\" align=\"center\" border=\"1\"><tr><th><b><h2>Operator</th> <th><b><h2>State</th> <th><b><h2>Amount</th> <th><b><h2>Offer detail</th><th><b><h2>Delete Offer</th>");
//out.print("<th><b><h2>Edit Offer</th>"
out.print("</tr></b>");
out.print("</br></br>");
...
while(rs.next())
{
	out.print("<tr class=\"tab\" height=\"40px\"><td  align=\"center\">");
 	...
 	<!--<td  align="center"> <a href="admineditoffers.jsp?id=<%=rs.getString("id")%>">Edit</a></td>-->
